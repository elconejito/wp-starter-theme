 ...
 *
 * Modified version of WP_Bootstrap_Navwalker from https://github.com/wp-bootstrap/wp-bootstrap-navwalker
 *
 * @package WST\Theme\TemplateNav
 */
...
class WP_Bootstrap_Navwalker extends \Walker_Nav_Menu {
    ...
    public function cssClasses($classes, $item) {
        ...
        if ($this->cpt) {
            ...
            if ($this->archive) {
                if (TemplateFunction\url_compare($this->archive, $item->url)) {
                    $classes[] = 'active';
                }
            }
        }
